...
export default function MainApp() {
  ...
  const handleDownloadJson = async () => {
    try {
      ...
      setJsonMessage(
        error instanceof Error ? error.message : "Unable to download cloud JSON."
      );
    }
  };
    ...
    <div className="app">
      <header className="hero">
        <nav className="navbar">
          ...
          <div style={{
            padding: '4px 8px', borderRadius: '6px', fontWeight: 'bold', color: '#b91c1c', border: '1px solid #b91c1c', cursor: 'pointer'
          }}
